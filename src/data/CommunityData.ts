...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    name: "Lucas W.",
    review:
      "Ghost VPN has completely transformed my streaming experience. I can now access shows and movies that were previously blocked in my region, and the connection is consistently fast with no annoying buffering.",
    rating: 5,
  },
  {
    id: "t7",
  ...
  },
  {
    ...
    name: "Aisha R.",
    review:
      "Ghost VPN has completely changed how I browse online. I feel secure knowing my data is encrypted, and I can access international websites for research without any restrictions. Highly recommend it!",
    rating: 5,
  },
  {
    id: "t12",
    name: "Ethan S.",
    review:
      "I never realized how much safer the internet could feel until I started using Ghost VPN. It’s fast, reliable, and makes online banking and shopping stress-free even on public networks.",
    rating: 5,
  },
];
